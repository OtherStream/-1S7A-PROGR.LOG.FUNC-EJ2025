% Definicioin de enfermedades
enfermedad(infeccion_urinaria).
enfermedad(cistitis).
enfermedad(infeccion_rinion).
...
enfermedad(gonorrea).
enfermedad(enfermedades_venereas).
enfermedad(jaquecas_neuronales).
enfermedad(tetano).
...
sintoma_enfermedad(empacho, pesadez_en_el_estomago).
sintoma_enfermedad(dolor_estomacal, ardor).
sintoma_enfermedad(gripe, fiebre_y_congestion).
sintoma_enfermedad(infecciones_garganta, dolor_garganta).
sintoma_enfermedad(colesterol, dolor_en_el_pecho).
sintoma_enfermedad(estres, tension_muscular).
sintoma_enfermedad(insomnio, dificultad_para_dormir).
sintoma_enfermedad(presion_alta, presion_alta).
...
sintoma_enfermedad(parasitos_intestinales, comezon_anal).
...
sintoma_enfermedad(anema, dolor_pecho).
...
sintoma_enfermedad(escrofulosis, inflamacion_ganglios).
...
sintoma_enfermedad(hinchazones, hinchazon).
...
sintoma_enfermedad(menstruacion_dolorosa, dolor_uterino).
...
sintoma_enfermedad(apoplejia, perdida_conciencia).
sintoma_enfermedad(congestion_cerebral, dolor_cabeza).
...
sintoma_enfermedad(varices, hinchazon_piernas).
sintoma_enfermedad(retencion_orina, dificultad_orinar).
sintoma_enfermedad(conjuntivitis, ojos_rojos).
...
sintoma_enfermedad(tosferina, secrecion_nasal).
sintoma_enfermedad(enfermedades_venereas, llagas).
sintoma_enfermedad(jaquecas_neuronales, nauseas).
sintoma_enfermedad(tetano, espasmos).
sintoma_enfermedad(eclampsia, convulsiones).
sintoma_enfermedad(inflamaciones_intestinales, cansancio).
sintoma_enfermedad(flujo, entumecimiento).
sintoma_enfermedad(afecciones_del_rinon, dolor_en_espalda).
sintoma_enfermedad(cirrosis_hepatica, picazon_en_la_piel).
sintoma_enfermedad(ictericia, piel_amarillenta).
sintoma_enfermedad(gonorrea, ardor_al_orinar).
...
sintoma_enfermedad(flatulencia, gases).
sintoma_enfermedad(obstruccion_mucosa_pecho, congestion).
...
% Descripciones de las acciones de las plantas
descripcion_accion(laxante, 'Sustancia que facilita la evacuaciÛn intestinal al estimular el movimiento del colon.').
descripcion_accion(diuretico, 'Sustancia que promueve la eliminaciÛn de lÌquidos a travÈs de la orina, ayudando a desintoxicar el organismo.').
descripcion_accion(antiparasitario, 'Sustancia que elimina o inhibe el crecimiento de par·sitos intestinales.').
  descripcion_accion(antiinflamatorio, 'Sustancia que reduce la inflamaciÛn y el dolor en tejidos afectados.').
descripcion_accion(analgesico, 'Sustancia que alivia el dolor sin eliminar su causa.').
descripcion_accion(antiseptico, 'Sustancia que previene el crecimiento de microorganismos, protegiendo contra infecciones.').
descripcion_accion(expectorante, 'Sustancia que facilita la expulsiÛn de flemas de las vÌas respiratorias.').
descripcion_accion(sedante, 'Sustancia que calma el sistema nervioso, promoviendo relajaciÛn o sueÒo.').
descripcion_accion(ansiolitico, 'Sustancia que reduce la ansiedad y el nerviosismo.').
descripcion_accion(antipiretico, 'Sustancia que ayuda a reducir la fiebre.').
descripcion_accion(cicatrizante, 'Sustancia que acelera la reparaciÛn de heridas o tejidos daÒados.').
descripcion_accion(carminativo, 'Sustancia que ayuda a eliminar gases del sistema digestivo.').
descripcion_accion(emoliente, 'Sustancia que ablanda y protege los tejidos, aliviando irritaciones.').
descripcion_accion(tonico, 'Sustancia que fortalece y revitaliza el organismo.').
descripcion_accion(hepatoprotector, 'Sustancia que protege y apoya la funciÛn del hÌgado.').
...
acciones_de_plantas(abrojo, diuretico).
acciones_de_plantas(abrojo, antiinflamatorio).
modo_tratamiento(abrojo, tres_veces_al_dia).
...
acciones_de_plantas(aconito, analgesico).
acciones_de_plantas(aconito, antipiretico).
acciones_de_plantas(aconito, antiinflamatorio).
...
acciones_de_plantas(adormidera, sedante).
acciones_de_plantas(adormidera, analgesico).
acciones_de_plantas(adormidera, ansiolitico).
...
acciones_de_plantas(aguacate, laxante).
acciones_de_plantas(aguacate, digestivo).
acciones_de_plantas(aguacate, expectorante).
...
acciones_de_plantas(ahuehuete, expectorante).
acciones_de_plantas(ahuehuete, antiseptico).
...
acciones_de_plantas(ajenjo, antiparasitario).
acciones_de_plantas(ajenjo, digestivo).
acciones_de_plantas(ajenjo, tonico).
...
acciones_de_plantas(ajo, antiinflamatorio).
acciones_de_plantas(ajo, vermifugo).
acciones_de_plantas(ajo, febrifugo).
acciones_de_plantas(ajo, diuretico).
acciones_de_plantas(ajo, expectorante).
acciones_de_plantas(ajo, antiparasitario).
...
acciones_de_plantas(albahaca, tonico_capilar).
acciones_de_plantas(albahaca, diuretica).
acciones_de_plantas(albahaca, carminativa).
acciones_de_plantas(albahaca, emenagoga).
...
acciones_de_plantas(alcachofa, descongestionante).
acciones_de_plantas(alcachofa, desinflamatorio).
...
acciones_de_plantas(alcanfor, analgesico).
acciones_de_plantas(alcanfor, antiseptico).
...
acciones_de_plantas(amapola_amarilla, sedante_suave).
acciones_de_plantas(amapola_amarilla, antiespasmodico).
...
acciones_de_plantas(amate, antiparasitario).
acciones_de_plantas(amate, antiinflamatorio).
...
acciones_de_plantas(anis, carminativo).
acciones_de_plantas(anis, expectorante).
...
acciones_de_plantas(anacahuite, expectorante).
acciones_de_plantas(anacahuite, balsamico).

% √Årnica
nombre_cientifico(arnica, 'Arnica montana').
continente_origen(arnica, europa).
pais_origen(arnica, suiza).
modo_preparacion(arnica, maceracion).
trata_enfermedad(arnica, golpes).
trata_enfermedad(arnica, torceduras).
trata_enfermedad(arnica, moretones).
acciones_de_plantas(arnica, antiinflamatoria).
acciones_de_plantas(arnica, cicatrizante).
acciones_de_plantas(arnica, analgesica).
...
acciones_de_plantas(barbasco, toxica).
acciones_de_plantas(barbasco, irritante).
acciones_de_plantas(barbasco, pesticida).

% Belladona
nombre_cientifico(belladona, 'Atropa belladonna').
continente_origen(belladona, europa).
pais_origen(belladona, europa_central).
modo_preparacion(belladona, maceracion).
...
acciones_de_plantas(belladona, antiespasmodica).
acciones_de_plantas(belladona, analgesica).
acciones_de_plantas(belladona, sedante).
acciones_de_plantas(belladona, toxica).
...
acciones_de_plantas(berro, expectorante).
acciones_de_plantas(berro, depurativa).
...
acciones_de_plantas(boldo, hepatoprotectora).
acciones_de_plantas(boldo, colagoga).
...
acciones_de_plantas(borraja, sudorifica).
acciones_de_plantas(borraja, antiinflamatoria).
...
acciones_de_plantas(bugambilia, expectorante).
acciones_de_plantas(bugambilia, antitusiva).
...
acciones_de_plantas(brionia, purgante).
acciones_de_plantas(brionia, antiparasitaria).
...
acciones_de_plantas(canela, estimulante).
acciones_de_plantas(canela, antimicrobiana).
...
acciones_de_plantas(cedron, expectorante).
acciones_de_plantas(cedron, calmante).
...
acciones_de_plantas(cardo_santo, oftalmica).
...
trata_enfermedad(cempasuchil, tumores).
acciones_de_plantas(cempasuchil, antiparasitario).
acciones_de_plantas(cempasuchil, tonico).
...
acciones_de_plantas(chaparro_amargoso, antiseptico).
...
acciones_de_plantas(chicalote, antiespasmodico).
acciones_de_plantas(chicalote, hipnotico).
acciones_de_plantas(chicalote, sedante).
...
acciones_de_plantas(chile, antiinflamatorio).
acciones_de_plantas(chile, rubefaciente).
...
acciones_de_plantas(chichigua, antiinflamatorio).
acciones_de_plantas(chichigua, antiseptico).
...
acciones_de_plantas(cilantro, carminativo).
acciones_de_plantas(cilantro, relajante).
...
trata_enfermedad(cocolmeca, anema).
acciones_de_plantas(cocolmeca, depurativo).
acciones_de_plantas(cocolmeca, antiinflamatorio).
...
acciones_de_plantas(cola_de_caballo, diuretico).
acciones_de_plantas(cola_de_caballo, remineralizante).
...
acciones_de_plantas(colchino, analgesico).
acciones_de_plantas(colchino, antiparasitario).
acciones_de_plantas(colchino, hepatoprotector).
...
acciones_de_plantas(comino, carminativo).
acciones_de_plantas(comino, antiespasmodico).
acciones_de_plantas(comino, digestivo).
...
acciones_de_plantas(colpachi, antipiretico).
acciones_de_plantas(colpachi, antiseptico).
acciones_de_plantas(colpachi, dermatologico).
...
acciones_de_plantas(cuachalalate, cicatrizante).
acciones_de_plantas(cuachalalate, astringente).
acciones_de_plantas(cuachalalate, antiinflamatorio).
...
acciones_de_plantas(cuajiote, laxante).
...
acciones_de_plantas(cuasia, analgesico).
acciones_de_plantas(cuasia, antiinflamatorio).
acciones_de_plantas(cuasia, hipoglucemiante).
...
acciones_de_plantas(damiana, relajante).
acciones_de_plantas(damiana, diuretico).
acciones_de_plantas(damiana, antiinflamatorio).
...
acciones_de_plantas(diente_de_leon, aperitivo).
acciones_de_plantas(diente_de_leon, depurativo).
acciones_de_plantas(diente_de_leon, laxante).
acciones_de_plantas(diente_de_leon, colagogo).
acciones_de_plantas(diente_de_leon, diuretico).
acciones_de_plantas(diente_de_leon, alimenticio).
...
acciones_de_plantas(digitaria, cardiotonica).
...
acciones_de_plantas(doradilla, diuretica).
acciones_de_plantas(doradilla, desinflamatoria).
...
acciones_de_plantas(epazote, antiparasitaria).
acciones_de_plantas(epazote, carminativa).
...
acciones_de_plantas(enebro, antiseptica).
acciones_de_plantas(enebro, diuretica).
...
trata_enfermedad(estafiate, dolor_estomacal).
acciones_de_plantas(estafiate, digestivo).
acciones_de_plantas(estafiate, antiparasitario).
modo_tratamiento(estafiate, una_taza_despues_de_los_alimentos).
...
acciones_de_plantas(eucalipto, expectorante).
acciones_de_plantas(eucalipto, antiseptico).
...
acciones_de_plantas(fenogreco, hipoglucemiante).
acciones_de_plantas(fenogreco, hipolipemiante).
...
acciones_de_plantas(genciana, estimulante).
acciones_de_plantas(genciana, tonico).
...
acciones_de_plantas(geranio, relajante).
acciones_de_plantas(geranio, ansiolitico).
...
acciones_de_plantas(girasol, diuretico).
acciones_de_plantas(girasol, antiinflamatorio).
modo_tratamiento(girasol, te_diario_o_compresas).

% Ginseng
nombre_cientifico(ginseng, 'Panax ginseng').
continente_origen(ginseng, asia).
pais_origen(ginseng, china).
modo_preparacion(ginseng, infusion).
trata_enfermedad(ginseng, diabetes).
trata_enfermedad(ginseng, fatiga).
acciones_de_plantas(ginseng, estimulante).
acciones_de_plantas(ginseng, adaptogeno).
modo_tratamiento(ginseng, infusion).
...
acciones_de_plantas(gordolobo, expectorante).
acciones_de_plantas(gordolobo, antiinflamatorio).
...
acciones_de_plantas(grama, diuretico).
acciones_de_plantas(grama, depurativo).
...
acciones_de_plantas(granado, astringente).
acciones_de_plantas(granado, antiparasitario).
modo_tratamiento(granado, te_o_enjuague_bucal).
...
acciones_de_plantas(guaco, antiinflamatorio).
acciones_de_plantas(guaco, broncodilatador).
...
acciones_de_plantas(guazuma, antidiarreico).
acciones_de_plantas(guazuma, antiinflamatorio).
...
acciones_de_plantas(guayacan, expectorante).
acciones_de_plantas(guayacan, antiesifilitico).
...
acciones_de_plantas(hamamelis, venotonico).
acciones_de_plantas(hamamelis, diuretico).
modo_tratamiento(hamamelis, infusion_15_minutos).

% Helenio
nombre_cientifico(helenio, 'Inula helenium').
continente_origen(helenio, europa).
modo_preparacion(helenio, infusion_de_raiz).
trata_enfermedad(helenio, bronquitis).
trata_enfermedad(helenio, tosferina).
trata_enfermedad(helenio, retencion_orina).
acciones_de_plantas(helenio, expectorante).
acciones_de_plantas(helenio, diuretico).
...
acciones_de_plantas(hierba_del_pollo, hemostatico).
acciones_de_plantas(hierba_del_pollo, cicatrizante).
acciones_de_plantas(hierba_del_pollo, diuretico).
...
trata_enfermedad(hinojo, obstruccion_mucosa_pecho).
acciones_de_plantas(hinojo, digestivo).
acciones_de_plantas(hinojo, carminativo).
acciones_de_plantas(hinojo, expectorante).
...
acciones_de_plantas(jalapa, purgante).
...
acciones_de_plantas(ipecacuana, expectorante).
...
trata_enfermedad(jazmin_amarillo, reumas).
...
acciones_de_plantas(jazmin_amarillo, analgesico).
acciones_de_plantas(jazmin_amarillo, antiespasmodico).
...
acciones_de_plantas(jengibre, estimulante).
acciones_de_plantas(jengibre, digestiva).
...
acciones_de_plantas(linaza, emoliente).
acciones_de_plantas(linaza, laxante).
...
acciones_de_plantas(llanten, antiinflamatoria).
acciones_de_plantas(llanten, astringente).
...
acciones_de_plantas(madreselva, expectorante).
acciones_de_plantas(madreselva, antibacteriana).
...
acciones_de_plantas(maguey, cicatrizante).
acciones_de_plantas(maguey, antimicrobiana).
acciones_de_plantas(maguey, antipiretica).
...
acciones_de_plantas(maiz, diuretico).
acciones_de_plantas(maiz, antiinflamatorio).
acciones_de_plantas(maiz, regulador_glucemia).
...
acciones_de_plantas(malva, emoliente).
acciones_de_plantas(malva, antiinflamatorio).
acciones_de_plantas(malva, laxante_suave).
acciones_de_plantas(malva, cicatrizante).
...
pais_origen(malvavisco, europa_oriental).
...
acciones_de_plantas(malvavisco, demulcente).
acciones_de_plantas(malvavisco, antitusivo).
acciones_de_plantas(malvavisco, antiacido).
acciones_de_plantas(malvavisco, emoliente_intenso).
...
acciones_de_plantas(mangle, astringente_intenso).
acciones_de_plantas(mangle, antiviral).
acciones_de_plantas(mangle, hemostatico).
acciones_de_plantas(mangle, cicatrizante).
acciones_de_plantas(mangle, hepatoprotector).
...
pais_origen(manzanilla, region_mediterranea).
...
acciones_de_plantas(manzanilla, sedante_suave).
acciones_de_plantas(manzanilla, antiespasmodico).
acciones_de_plantas(manzanilla, antiinflamatorio).
acciones_de_plantas(manzanilla, carminativo).
acciones_de_plantas(manzanilla, emenagogo).
...
trata_enfermedad(marrubio, bronquitis).
acciones_de_plantas(marrubio, expectorante).
acciones_de_plantas(marrubio, tonico_capilar).
acciones_de_plantas(marrubio, antiinflamatorio).
modo_tratamiento(marrubio, tomar_infusion_2_veces_al_dia).

% Menta
nombre_cientifico(menta, 'Mentha piperita').
continente_origen(menta, europa).
pais_origen(menta, region_mediterranea).
modo_preparacion(menta, infusion).
modo_preparacion(menta, aceite_esencial).
trata_enfermedad(menta, dolor_de_estomago).
trata_enfermedad(menta, indigestion).
trata_enfermedad(menta, colicos).
acciones_de_plantas(menta, carminativo).
acciones_de_plantas(menta, antiespasmodico).
acciones_de_plantas(menta, refrescante).
modo_tratamiento(menta, infusion_despues_comidas).
modo_tratamiento(menta, aplicar_aceite_diluido).

% Mezquite
nombre_cientifico(mezquite, 'Prosopis juliflora').
continente_origen(mezquite, america).
pais_origen(mezquite, mexico).
modo_preparacion(mezquite, decoccion).
trata_enfermedad(mezquite, diarrea).
trata_enfermedad(mezquite, inflamacion).
acciones_de_plantas(mezquite, astringente).
acciones_de_plantas(mezquite, antiinflamatorio).
modo_tratamiento(mezquite, tomar_decoccion_2_veces_al_dia).

% Muicle
nombre_cientifico(muicle, 'Justicia spicigera').
continente_origen(muicle, america).
pais_origen(muicle, mexico).
modo_preparacion(muicle, infusion).
trata_enfermedad(muicle, anemia).
trata_enfermedad(muicle, diabetes).
trata_enfermedad(muicle, infecciones).
acciones_de_plantas(muicle, tonico).
acciones_de_plantas(muicle, hipoglucemiante).
acciones_de_plantas(muicle, antimicrobiano).
modo_tratamiento(muicle, infusion_3_veces_al_dia).

% Naranjo
nombre_cientifico(naranjo, 'Citrus sinensis').
continente_origen(naranjo, asia).
pais_origen(naranjo, china).
modo_preparacion(naranjo, infusion_hojas).
trata_enfermedad(naranjo, insomnio).
trata_enfermedad(naranjo, ansiedad).
acciones_de_plantas(naranjo, sedante).
acciones_de_plantas(naranjo, relajante).
modo_tratamiento(naranjo, infusion_antes_de_dormir).
...
modo_preparacion(nopal, cocido).
trata_enfermedad(nopal, diabetes).
trata_enfermedad(nopal, colesterol).
trata_enfermedad(nopal, obesidad).
acciones_de_plantas(nopal, hipoglucemiante).
acciones_de_plantas(nopal, hipolipemiante).
acciones_de_plantas(nopal, saciante).
modo_tratamiento(nopal, consumir_jugo_en_ayunas).
modo_tratamiento(nopal, incluir_en_dieta).

% Nogal
nombre_cientifico(nogal, 'Juglans regia').
continente_origen(nogal, asia).
pais_origen(nogal, persia).
modo_preparacion(nogal, infusion_hojas).
trata_enfermedad(nogal, diabetes).
trata_enfermedad(nogal, infecciones_piel).
acciones_de_plantas(nogal, hipoglucemiante).
acciones_de_plantas(nogal, astringente).
modo_tratamiento(nogal, infusion_2_veces_al_dia).
...
acciones_de_plantas(oregano, expectorante).
acciones_de_plantas(oregano, carminativo).
modo_tratamiento(oregano, infusion_2_3_veces_al_dia).

% Ortiga
nombre_cientifico(ortiga, 'Urtica dioica').
continente_origen(ortiga, europa).
pais_origen(ortiga, region_mediterranea).
modo_preparacion(ortiga, infusion).
trata_enfermedad(ortiga, anemia).
trata_enfermedad(ortiga, reumatismo).
acciones_de_plantas(ortiga, tonico).
acciones_de_plantas(ortiga, antiinflamatorio).
modo_tratamiento(ortiga, infusion_2_veces_al_dia).

% Palo azul
nombre_cientifico(palo_azul, 'Eysenhardtia polystachya').
continente_origen(palo_azul, america).
pais_origen(palo_azul, mexico).
modo_preparacion(palo_azul, decoccion).
trata_enfermedad(palo_azul, problemas_renales).
trata_enfermedad(palo_azul, infecciones_urinarias).
acciones_de_plantas(palo_azul, diuretico).
acciones_de_plantas(palo_azul, antiinflamatorio).
modo_tratamiento(palo_azul, tomar_decoccion_3_veces_al_dia).

% Perejil
nombre_cientifico(perejil, 'Petroselinum crispum').
...
trata_enfermedad(perejil, hipertension).
acciones_de_plantas(perejil, diuretico).
acciones_de_plantas(perejil, hipotensor).
modo_tratamiento(perejil, infusion_2_veces_al_dia).

% Pinguica
nombre_cientifico(pinguica, 'Arctostaphylos pungens').
continente_origen(pinguica, america).
pais_origen(pinguica, mexico).
modo_preparacion(pinguica, infusion).
trata_enfermedad(pinguica, infecciones_urinarias).
trata_enfermedad(pinguica, inflamacion).
acciones_de_plantas(pinguica, diuretico).
acciones_de_plantas(pinguica, antiinflamatorio).
modo_tratamiento(pinguica, infusion_3_veces_al_dia).

% Pirul
nombre_cientifico(pirul, 'Schinus molle').
continente_origen(pirul, america).
pais_origen(pirul, peru).
modo_preparacion(pirul, infusion).
trata_enfermedad(pirul, reumatismo).
trata_enfermedad(pirul, infecciones_urinarias).
acciones_de_plantas(pirul, antiinflamatorio).
acciones_de_plantas(pirul, diuretico).
modo_tratamiento(pirul, infusion_2_veces_al_dia).

% R·bano
nombre_cientifico(rabano, 'Raphanus sativus').
continente_origen(rabano, asia).
pais_origen(rabano, china).
modo_preparacion(rabano, jugo).
trata_enfermedad(rabano, problemas_hepaticos).
trata_enfermedad(rabano, estreÒimiento).
acciones_de_plantas(rabano, colagogo).
acciones_de_plantas(rabano, laxante).
modo_tratamiento(rabano, jugo_en_ayunas).
...
trata_enfermedad(romero, indigestion).
acciones_de_plantas(romero, estimulante).
acciones_de_plantas(romero, carminativo).
modo_tratamiento(romero, infusion_2_veces_al_dia).

% Rosa de castilla
nombre_cientifico(rosa_de_castilla, 'Rosa gallina').
continente_origen(rosa_de_castilla, europa).
pais_origen(rosa_de_castilla, francia).
modo_preparacion(rosa_de_castilla, infusion).
trata_enfermedad(rosa_de_castilla, ansiedad).
trata_enfermedad(rosa_de_castilla, problemas_cutaneos).
acciones_de_plantas(rosa_de_castilla, relajante).
acciones_de_plantas(rosa_de_castilla, astringente).
modo_tratamiento(rosa_de_castilla, infusion_o_compresas).
...
trata_enfermedad(ruda, ansiedad).
acciones_de_plantas(ruda, emenagogo).
acciones_de_plantas(ruda, relajante).
modo_tratamiento(ruda, infusion_1_vez_al_dia).
...
acciones_de_plantas(salvia, antisudorifico).
acciones_de_plantas(salvia, antiseptico).
modo_tratamiento(salvia, infusion_o_gargaras).

% S·bila
nombre_cientifico(sabila, 'Aloe vera').
continente_origen(sabila, africa).
pais_origen(sabila, peninsula_arabiga).
modo_preparacion(sabila, gel).
modo_preparacion(sabila, jugo).
trata_enfermedad(sabila, quemaduras).
trata_enfermedad(sabila, problemas_cutaneos).
trata_enfermedad(sabila, estrenimiento).
acciones_de_plantas(sabila, cicatrizante).
acciones_de_plantas(sabila, laxante).
acciones_de_plantas(sabila, emoliente).
modo_tratamiento(sabila, aplicar_gel_directamente).
modo_tratamiento(sabila, tomar_jugo_diluido).

% Sa˙co
nombre_cientifico(sauco, 'Sambucus nigra').
continente_origen(sauco, europa).
pais_origen(sauco, region_mediterranea).
modo_preparacion(sauco, infusion).
trata_enfermedad(sauco, resfriado).
trata_enfermedad(sauco, fiebre).
acciones_de_plantas(sauco, sudorifico).
acciones_de_plantas(sauco, antiviral).
modo_tratamiento(sauco, infusion_3_veces_al_dia).

% Siete venas
nombre_cientifico(siete_venas, 'Blechnum occidentale').
continente_origen(siete_venas, america).
pais_origen(siete_venas, mexico).
modo_preparacion(siete_venas, cocimiento).
trata_enfermedad(siete_venas, higado).
acciones_de_plantas(siete_venas, hepatoprotector).
acciones_de_plantas(siete_venas, depurativo).
modo_tratamiento(siete_venas, tomar_cocimiento_2_veces_al_dia).

% Tabaquillo
nombre_cientifico(tabaquillo, 'Nicotiana glauca').
continente_origen(tabaquillo, america).
pais_origen(tabaquillo, argentina).
modo_preparacion(tabaquillo, cataplasma).
trata_enfermedad(tabaquillo, reumatismo).
trata_enfermedad(tabaquillo, dolor_muscular).
acciones_de_plantas(tabaquillo, analgesico).
acciones_de_plantas(tabaquillo, antiinflamatorio).
modo_tratamiento(tabaquillo, aplicar_cataplasma).

% Tejocote
nombre_cientifico(tejocote, 'Crataegus mexicana').
continente_origen(tejocote, america).
pais_origen(tejocote, mexico).
modo_preparacion(tejocote, infusion).
trata_enfermedad(tejocote, problemas_respiratorios).
trata_enfermedad(tejocote, hipertension).
acciones_de_plantas(tejocote, cardiotonico).
acciones_de_plantas(tejocote, hipotensor).
modo_tratamiento(tejocote, infusion_2_veces_al_dia).

% Tila
nombre_cientifico(tila, 'Tilia platyphyllos').
continente_origen(tila, europa).
pais_origen(tila, region_mediterranea).
modo_preparacion(tila, infusion).
trata_enfermedad(tila, ansiedad).
trata_enfermedad(tila, insomnio).
acciones_de_plantas(tila, sedante).
acciones_de_plantas(tila, relajante).
modo_tratamiento(tila, infusion_antes_de_dormir).

% Tomillo
nombre_cientifico(tomillo, 'Thymus vulgaris').
...
trata_enfermedad(tomillo, bronquitis).
acciones_de_plantas(tomillo, expectorante).
acciones_de_plantas(tomillo, antiseptico).
modo_tratamiento(tomillo, infusion_3_veces_al_dia).

% Toronjil
nombre_cientifico(toronjil, 'Melissa officinalis').
continente_origen(toronjil, europa).
pais_origen(toronjil, region_mediterranea).
modo_preparacion(toronjil, infusion).
trata_enfermedad(toronjil, ansiedad).
trata_enfermedad(toronjil, insomnio).
acciones_de_plantas(toronjil, sedante).
acciones_de_plantas(toronjil, relajante).
modo_tratamiento(toronjil, infusion_antes_de_dormir).

% Tripa de judas
nombre_cientifico(tripa_de_judas, 'Cuscuta americana').
continente_origen(tripa_de_judas, america).
pais_origen(tripa_de_judas, mexico).
modo_preparacion(tripa_de_judas, infusion).
trata_enfermedad(tripa_de_judas, problemas_hepaticos).
trata_enfermedad(tripa_de_judas, ictericia).
acciones_de_plantas(tripa_de_judas, hepatoprotector).
acciones_de_plantas(tripa_de_judas, colagogo).
modo_tratamiento(tripa_de_judas, infusion_2_veces_al_dia).
